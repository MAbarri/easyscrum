...
public class DAOsprintImpl implements DAOsprint {
	...
	public void init()
	{
		list.add(new Sprint(1,"Main Sprint", "08/09/2014", "28/09/2014", "Finished"));
		list.add(new Sprint(1,"Side Sprint", "08/02/2014", "28/02/2014", "Finished"));
		list.add(new Sprint(1,"Final Sprint", "08/01/2015", "28/01/2015", "working on"));
