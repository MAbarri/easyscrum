...
<link rel="stylesheet"
	href="/easyscrumweb/resources/css/screenshare.css">
...
<!-- scripts used for screen-sharing -->
        ...
        <script src="/easyscrumweb/resources/js/screenshare/conference.js"> </script>
</head>
<body>
	...
	<div id="cover" class="backprofil">
		...
		<div class="panel panel-default clientPanel">
			...
			<!-- screeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeen -->
			            <!-- just copy this <section> and next script -->
			            
            <section class="experiment">
            <c:if test="${sessionScope.user.type=='4'}">                
                <section class="videospace">
                    <span>
            ...
            <section class="experiment">
                ...
                <ol>
                    ...
                    <li>
                        Firefox? <a href="https://www.webrtc-experiment.com/store/firefox-extension/enable-screen-capturing.xpi">Install Firefox Extension</a>
                    </li>
                </ol>
            </section>
			<!-- screeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeen end -->
			</div>
		</div>
	</div>
	<!-- Sticky footer -->
