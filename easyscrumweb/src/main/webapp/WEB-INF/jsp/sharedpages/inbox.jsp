							...
							<div class="tab-pane fade in active" id="home">
								<div class="list-group">
									<a href="/easyscrumweb/userspace/mail" class="list-group-item">
										...
										class="name" style="min-width: 120px; display: inline-block;">Project Owner 1</span> <span class="">Subject</span> <span
										class="text-muted" style="font-size: 11px;">- Hi hello
											how r u ?</span> <span class="badge">12:10 AM</span> <span
										class="pull-right"><span
											class="glyphicon glyphicon-paperclip"> </span></span>
									</a><a href="/easyscrumweb/userspace/mail" class="list-group-item read">
										<div class="checkbox">
											<label> <input type="checkbox">
											</label>
										</div> <span class="glyphicon glyphicon-star-empty"></span><span
										class="name" style="min-width: 120px; display: inline-block;">Scrum Master 1</span> <span class="">Subject</span> <span
										class="text-muted" style="font-size: 11px;">- Hi hello
											how r u ?</span> <span class="badge">12:10 AM</span> <span
										class="pull-right"><span
											class="glyphicon glyphicon-paperclip"> </span></span>
